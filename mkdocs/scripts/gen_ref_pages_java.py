...
mkdoxy = mkdocs_gen_files.config["plugins"].get("mkdoxy")
if mkdoxy and mkdoxy.config.get("enabled"):
	nav = mkdocs_gen_files.Nav()

	# Include in navigation all Java files generated by Doxygen that start with configured prefixes
	prefixes = tuple(mkdocs_gen_files.config["extra"]["nem"]["java-sdk"]["include-prefixes"])
