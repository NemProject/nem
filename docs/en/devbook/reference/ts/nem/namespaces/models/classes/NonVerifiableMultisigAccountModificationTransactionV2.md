...
### new NonVerifiableMultisigAccountModificationTransactionV2()

```ts
new NonVerifiableMultisigAccountModificationTransactionV2(): NonVerifiableMultisigAccountModificationTransactionV2
```
...
| <a id="_minapprovaldeltasize"></a> `_minApprovalDeltaSize` | `public` | `number` | - | - |
| <a id="_modifications"></a> `_modifications` | `public` | `any`[] | - | - |
...
| `TYPE_HINTS.modifications` | `public` | `string` | - | - |
...
```ts
static deserialize(payload): NonVerifiableMultisigAccountModificationTransactionV2
```
