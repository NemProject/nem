...
public class TransactionFactory {
	 ...
	 */
	public static final ObjectDeserializer<Transaction> VERIFIABLE = deserializer -> deserialize(
	 ...
	 */
	public static final ObjectDeserializer<Transaction> NON_VERIFIABLE = deserializer -> deserialize(
			VerifiableEntity.DeserializationOptions.NON_VERIFIABLE, deserializer);

	@SuppressWarnings("serial")
	private static final Map<Integer, BiFunction<VerifiableEntity.DeserializationOptions, Deserializer, Transaction>> TYPE_TO_CONSTRUCTOR_MAP = new HashMap<Integer, BiFunction<VerifiableEntity.DeserializationOptions, Deserializer, Transaction>>() {
		{
	...
	private static Transaction deserialize(final VerifiableEntity.DeserializationOptions options, final Deserializer deserializer) {
		...
		final BiFunction<VerifiableEntity.DeserializationOptions, Deserializer, Transaction> constructor = TYPE_TO_CONSTRUCTOR_MAP
