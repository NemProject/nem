...
public class BlockMapperTest {
	...
	private class TestContext {
		...
		public void addMultisigModificationTransactions() {
			final List<MultisigModification> modifications1 = Collections.singletonList(new MultisigModification(MultisigModificationType.Add, this.account2));
			this.model.addTransaction(new MultisigAggregateModificationTransaction(new TimeInstant(150), this.account1, modifications1));
			final List<MultisigModification> modifications2 = Collections.singletonList(new MultisigModification(MultisigModificationType.Add, this.account3));
