...
public class NodeMetaDataTest {
	...
	public void metaDataCanBeCreated() {
		// Act:
		final NodeMetaData metaData = new NodeMetaData("plat", "app", new NodeVersion(3, 0, 0), 7);
	...
	public void metaDataCanBeDeserializedWithAllParameters() {
		// Act:
		final NodeMetaData metaData = createMetaDataFromJson("plat", "app", "3.0.0", 7);
	...
	@Test
	public void metaDataCanBeDeserializedWithoutBitmask() {
		// Act:
		final NodeMetaData metaData = createMetaDataFromJson("plat", "app", "3.0.0", null);
	...
	public void metaDataCanBeDeserializedWithOnlyVersion() {
		// Act:
		final NodeMetaData metaData = createMetaDataFromJson(null, null, "3.0.0", null);
	...
	public void metaDataCannotBeDeserializedWithoutVersion() {
		// Act:
		createMetaDataFromJson("plat", "app", null, 7);
	}

	private static NodeMetaData createMetaDataFromJson(final String platform, final String application, final String version, final Integer features) {
	...
	public void metaDataCanBeRoundTripped() {
		...
		final Deserializer deserializer = Utils.roundtripSerializableEntity(
				new NodeMetaData("plat", "app", new NodeVersion(3, 0, 0), 7),
				null);
	...
	private static final Map<String, NodeMetaData> DESC_TO_META_DATA_MAP = new HashMap<String, NodeMetaData>() {
		{
			this.put("default", new NodeMetaData("plat", "app", new NodeVersion(1, 0, 0), 7));

			this.put("no-platform", new NodeMetaData(null, "app", new NodeVersion(1, 0, 0), 7));
			this.put("no-app", new NodeMetaData("plat", null, new NodeVersion(1, 0, 0), 7));
			this.put("no-version", new NodeMetaData("plat", "app", null, 7));
			this.put("no-features", new NodeMetaData("plat", "app", new NodeVersion(1, 0, 0), 0));

			this.put("diff-platform", new NodeMetaData("plat2", "app", new NodeVersion(1, 0, 0), 7));
			this.put("diff-app", new NodeMetaData("plat", "app2", new NodeVersion(1, 0, 0), 7));
			this.put("diff-version", new NodeMetaData("plat", "app", new NodeVersion(2, 0, 0), 7));
			this.put("diff-features", new NodeMetaData("plat", "app", new NodeVersion(1, 0, 0), 6));
		}
	};
	...
	public void equalsOnlyReturnsTrueForEquivalentObjects() {
		// Arrange:
		final NodeMetaData metaData = new NodeMetaData("plat", "app", new NodeVersion(1, 0, 0), 7);
	...
	public void hashCodesAreEqualForEquivalentObjects() {
		// Arrange:
		final int hashCode = new NodeMetaData("plat", "app", new NodeVersion(1, 0, 0), 7).hashCode();
