# Class: NonVerifiableCosignatureV1
...
### new NonVerifiableCosignatureV1()

```ts
new NonVerifiableCosignatureV1(): NonVerifiableCosignatureV1
```
...
```ts
static deserialize(payload): NonVerifiableCosignatureV1
```
