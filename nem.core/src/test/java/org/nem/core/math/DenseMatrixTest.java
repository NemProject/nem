...
public class DenseMatrixTest extends MatrixTest<DenseMatrix> {
	...
	public void matrixCannotBeInitializedWithIncompleteDefaultValues() {
		// Assert:
		ExceptionAssert.assertThrows(v -> new DenseMatrix(2, 3, new double[]{
				1, 4, 5, 7, 2
	...
	public void rawVectorIsAccessible() {
		// Arrange:
		final DenseMatrix matrix = this.createMatrix(3, 2, new double[]{
				9.0, 3.2, 5.4, 1.2, 4.3, 7.6
		});

		// Act:
		final boolean areEqual = Arrays.equals(matrix.getRaw(), new double[]{
				9.0, 3.2, 5.4, 1.2, 4.3, 7.6
		});
	...
	public void denseMatrixStringRepresentationIsCorrect() {
		...
		// Assert:
		final String expectedResult = "2.123 11.123" + System.lineSeparator() + "3.235 1.000" + System.lineSeparator() + "5012.013 8.000";
