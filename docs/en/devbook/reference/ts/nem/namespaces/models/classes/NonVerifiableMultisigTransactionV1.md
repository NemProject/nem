...
### new NonVerifiableMultisigTransactionV1()

```ts
new NonVerifiableMultisigTransactionV1(): NonVerifiableMultisigTransactionV1
```
...
| <a id="_innertransaction"></a> `_innerTransaction` | `public` | [`NonVerifiableTransaction`](NonVerifiableTransaction.md) | - | - |
...
| `TYPE_HINTS.innerTransaction` | `public` | `string` | - | - |
...
```ts
set innerTransaction(value): void
```
...
| Parameter | Type |
| ------ | ------ |
| `value` | [`NonVerifiableTransaction`](NonVerifiableTransaction.md) |
...
```ts
static deserialize(payload): NonVerifiableMultisigTransactionV1
```
