...
### new NonVerifiableTransferTransactionV2()

```ts
new NonVerifiableTransferTransactionV2(): NonVerifiableTransferTransactionV2
```
...
```ts
static deserialize(payload): NonVerifiableTransferTransactionV2
```
