...
### new NonVerifiableNamespaceRegistrationTransactionV1()

```ts
new NonVerifiableNamespaceRegistrationTransactionV1(): NonVerifiableNamespaceRegistrationTransactionV1
```
...
| <a id="_parentname"></a> `_parentName` | `public` | `any` | - | - |
...
| `TYPE_HINTS.parentName` | `public` | `string` | - | - |
...
```ts
static deserialize(payload): NonVerifiableNamespaceRegistrationTransactionV1
```
