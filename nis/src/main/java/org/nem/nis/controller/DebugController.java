...
public class DebugController {
	...
	public BlockDebugInfo blockDebugInfo(@RequestParam(value = "height") final String height) {
		...
		final org.nem.nis.dbmodel.DbBlock dbBlock = this.blockDao.findByHeight(blockHeight);
		final Block block = BlockMapper.toModel(dbBlock, accountLookup);

		final org.nem.nis.dbmodel.DbBlock dbParent = 1 == blockHeight.getRaw() ? null : this.blockDao.findByHeight(blockHeight.prev());
