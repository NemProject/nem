...
/**
 * similar to transaction factory, but for the blocks <br>
 * I doubt there is need for this now or in future, but let's have similar API for both transactions and blocks
 */
