...
### new NonVerifiableTransferTransactionV1()

```ts
new NonVerifiableTransferTransactionV1(): NonVerifiableTransferTransactionV1
```
...
```ts
static deserialize(payload): NonVerifiableTransferTransactionV1
```
