...
### new MosaicSupplyChangeTransactionV1()

```ts
new MosaicSupplyChangeTransactionV1(): MosaicSupplyChangeTransactionV1
```
...
```ts
static deserialize(payload): MosaicSupplyChangeTransactionV1
```
