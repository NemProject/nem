...
### new MultisigAccountModificationTransactionV2()

```ts
new MultisigAccountModificationTransactionV2(): MultisigAccountModificationTransactionV2
```
...
```ts
static deserialize(payload): MultisigAccountModificationTransactionV2
```
