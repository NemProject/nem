...
### new MosaicDefinitionTransactionV1()

```ts
new MosaicDefinitionTransactionV1(): MosaicDefinitionTransactionV1
```
...
```ts
static deserialize(payload): MosaicDefinitionTransactionV1
```
