...
public class SerializableEntityHttpMessageConverterTest {
	...
	public void writeCreatesUtf8JsonStringThatCanBeRoundTripped() throws Exception {
		...
		// TODO-CR: T-J/G I guess I found the problem. It was related to the MockHttpOutputMessage
		// It used toString without specifying the encoding. I added that and now the test case runs
		// smooth.
		// Testing is one thing...testing the test code another ;)
