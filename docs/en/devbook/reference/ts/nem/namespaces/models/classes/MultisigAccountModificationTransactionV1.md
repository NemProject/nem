...
### new MultisigAccountModificationTransactionV1()

```ts
new MultisigAccountModificationTransactionV1(): MultisigAccountModificationTransactionV1
```
...
```ts
static deserialize(payload): MultisigAccountModificationTransactionV1
```
