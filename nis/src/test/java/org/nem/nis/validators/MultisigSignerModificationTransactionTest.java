	...
	public static class MultisigSignerModificationTransactionMainTest {
		...
		public void cannotCreateMultisigSignerModificationWithNullModifications() {
			...
			ExceptionAssert.assertThrows(
					v -> new MultisigSignerModificationTransaction(AbstractMultisigSignerModificationTransactionTest.TIME, signer, null),
		...
		public void cannotCreateMultisigSignerModificationWithEmptyModifications() {
			...
			// Act:
			ExceptionAssert.assertThrows(
					v -> new MultisigSignerModificationTransaction(AbstractMultisigSignerModificationTransactionTest.TIME, signer, new ArrayList<>()),
					IllegalArgumentException.class);
		}
		//endregion
