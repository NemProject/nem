...
public class ImportanceTransferDaoImpl implements ImportanceTransferDao {
	private final SimpleTransferDaoImpl<DbImportanceTransferTransaction> impl;
	...
	@Override
	@Transactional(readOnly = true)
	public DbImportanceTransferTransaction findByHash(final byte[] txHash) {
		return this.impl.findByHash(txHash);
	}

	@Override
	@Transactional(readOnly = true)
	public DbImportanceTransferTransaction findByHash(final byte[] txHash, final long maxBlockHeight) {
	...
	@Override
	@Transactional
	public void save(final DbImportanceTransferTransaction entity) {
		this.impl.save(entity);
	}

	@Override
	@Transactional
	public void saveMulti(final List<DbImportanceTransferTransaction> transfers) {
