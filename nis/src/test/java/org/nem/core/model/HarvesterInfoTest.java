...
public class HarvesterInfoTest {
	...
	public void harvesterInfoCtorSetsProperFields() {
		// Arrange + Act:
		final HarvesterInfo result = new HarvesterInfo(Hash.fromHexString("aabbcc"), new BlockHeight(123), Amount.fromMicroNem(45678));
	...
	public void canRoundTripHarvesterInfo() {
		// Arrange:
		final HarvesterInfo entity = new HarvesterInfo(Hash.fromHexString("aabbcc"), new BlockHeight(123), Amount.fromMicroNem(45678));
