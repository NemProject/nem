...
### new NonVerifiableMultisigAccountModificationTransactionV1()

```ts
new NonVerifiableMultisigAccountModificationTransactionV1(): NonVerifiableMultisigAccountModificationTransactionV1
```
...
```ts
static deserialize(payload): NonVerifiableMultisigAccountModificationTransactionV1
```
