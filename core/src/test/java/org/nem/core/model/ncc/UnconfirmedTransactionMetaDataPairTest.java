...
public class UnconfirmedTransactionMetaDataPairTest extends AbstractMetaDataPairTest<Transaction, UnconfirmedTransactionMetaData> {
	...
	public UnconfirmedTransactionMetaDataPairTest() {
		super(account -> {
			...
			transfer.sign();
			return transfer;
		}, id -> new UnconfirmedTransactionMetaData(Hash.fromHexString(Integer.toHexString(id))), UnconfirmedTransactionMetaDataPair::new,
				UnconfirmedTransactionMetaDataPair::new, transaction -> transaction.getSigner().getAddress(),
