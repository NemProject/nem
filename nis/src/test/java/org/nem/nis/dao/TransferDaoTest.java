...
public class TransferDaoTest {
	...
	private class MultisigTestContext {
		...
		private MultisigAggregateModificationTransaction createMultisigAggregateModificationTransaction(
			...
			final List<MultisigModification> modifications = Collections.singletonList(new MultisigModification(MultisigModificationType.AddCosignatory, newCosignatory));
